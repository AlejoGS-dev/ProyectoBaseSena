...
<div class="messenger">
    ...
    <div class="messenger-listView {{ !!$id ? 'conversation-active' : '' }}">
        ...
        <div class="m-header">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                {{-- Logo + título MESSAGES --}}
                <a href="#"
                   class="messenger-brand chatify-d-flex chatify-align-items-center">
                    <img src="{{ asset('images/Logo_Freeland_1.svg') }}"
                         alt="Freeland"
                         class="freeland-logo">
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                {{-- back button, avatar y nombre --}}
                <div class="chatify-d-flex chatify-align-items-center">
                    <a href="#" class="show-listView">
                        <i class="fas fa-arrow-left"></i>
                    </a>

                    {{-- Avatar de la conversación (Chatify lo rellena con JS) --}}
                    <div class="avatar av-s header-avatar"
                         style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;">
                    </div>

                    {{-- Nombre de la conversación / por defecto config('chatify.name') --}}
